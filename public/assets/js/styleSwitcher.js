...
(function ($) {
  ...
  const versionSelectIcon = $("#btnDarkLightMode .theme_version_icon");
  ...
  versionSelectIcon.on("click", function () {
    let versionTo = $(this).attr("data-version_to");
    body.attr("data-theme-version", versionTo);
    setCookie("version", versionTo);
    if (versionTo == "dark") {
      $(".img-moon-mode").addClass("d-none");
      $(".img-sun-mode").removeClass("d-none");
    } else {
      $(".img-moon-mode").removeClass("d-none");
      $(".img-sun-mode").addClass("d-none");
    }
  });
